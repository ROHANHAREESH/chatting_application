...
public class Client implements ActionListener{
	...
	f1.setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/5.jpg"));
    ...
    public void sendTextToFile(String message){
    	...
    	try
    	{
    		BuffWriter = new BufferedWriter(new FileWriter(new File("chat.txt"),true));
    		BuffWriter.write("\nClient : "+message);
